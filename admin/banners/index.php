            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <td><?= $banner['is_active'] ? "Active" : "Deactivated";
                      ?></td>
                    <td><?= $banner['is_draft'] ? "Drafted" : "Not Draft";
                        ?></td>

                  <td> <a class="btn btn-dark" href="show.php?id=<?php echo $banner['id']; ?>"> Show </a> |
                    <a class="btn btn-success" href="edit.php?id=<?php echo $banner['id']; ?>"> Edit </a> |
                    <a class="btn btn-danger" onclick="myFunction()" href="trash.php?id=<?php echo $banner['id']; ?>"> Trash
                    </a>
                  </td>
                </tr>
              <?php
