              ...
              ?>
                <tr>
                  ...
                  <td>
                    ...
                    <a class="btn btn-danger" onclick="myFunction()" href="delete.php?id=<?php echo $product['id']; ?>"> Delete </a>
                    <a class="btn btn-success" onclick="myFunction()" href="restore.php?id=<?php echo $product['id']; ?>"> Restore
                    </a>
                  </td>
                </tr>
              <?php
