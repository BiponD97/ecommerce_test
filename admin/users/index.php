      ...
      <div class="row justify-content-center">
        <div class="col-sm-12">
          ...
          <ul class="nav justify-content-center fs-3 mb-2">
            ...
            <li class="nav-item">
              <a class="nav-link" href="trash_index.php">Trashed Users</a>
            </li>
            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <td> <a class="btn btn-dark" href="show.php?id=<?php echo $user['id']; ?>"> Show </a> |
                    <a class="btn btn-warning" href="edit.php?id=<?php echo $user['id']; ?>"> Edit </a> |


                    <a class="btn btn-danger" onclick="myFunction()" href="trash.php?id=<?php echo $user['id']; ?>"> Trash
                    </a>
                  </td>
                </tr>
              <?php
